...
return [
    ...
    */
    ...
    'manifests' => [
        ...
        'blocks' => [
            'path' => get_theme_file_path('blocks/public'),
            'url' => get_theme_file_uri('blocks/public'),
            'assets' => get_theme_file_path('blocks/public/manifest.json'),
            'bundles' => get_theme_file_path('blocks/public/entrypoints.json'),
        ]
    ]
];
